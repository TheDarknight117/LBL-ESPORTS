...
export const OFFICIAL_LBL_TEAM_LOGOS = {
    ...
    'quinteto de nos':    { nombre: 'Quinteto de nos', tag: 'QDN', logo: '/assets/teams/quinteto_de_nos.webp', logoFallback: 'https://i.ibb.co/SXd2qZWf/QUINTETO-DE-NOS2.png', tier: 'Tier 2' },
    ...
    'kaox esports':       { nombre: 'Kaox Esports', tag: 'KXE', logo: '/assets/teams/kaox_esports.webp', logoFallback: 'https://i.ibb.co/ymKntgG2/Kaox-Esports-OF.png', tier: 'Tier 1' },
...
export async function procesarTorneoChallonge(tournamentSlugOrId, apiKey = null, equiposLBL = [], tierLabel = 'Tier 1') {
    ...
    const matchesProcesadas = rawMatches.map(item => {
        ...
        return {
            ...
            suggested_play_order: m.suggested_play_order || null,
            ...
            player1_prereq_match_id: m.player1_prereq_match_id || null,
            player2_prereq_match_id: m.player2_prereq_match_id || null,
            player1_is_prereq_match_loser: !!m.player1_is_prereq_match_loser,
            player2_is_prereq_match_loser: !!m.player2_is_prereq_match_loser,
            player1: p1 ? { ...p1.lblInfo, seed: p1.seed } : { nombre: 'TBD', tag: 'TBD', logo: '' },
            player2: p2 ? { ...p2.lblInfo, seed: p2.seed } : { nombre: 'TBD', tag: 'TBD', logo: '' },
